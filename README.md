...
- **Scale decision**: the bank stays a JSON file until it passes **25,000 entries** (~68 years of dailies) or something needs search/random access — then it migrates to SQLite in-repo (still no server, no keys). No hosted database before that.
